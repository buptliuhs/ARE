...
public class SqlDatabaseDescription {
    ...
    /**
     * The database table name. Has a {@code null} value in case table name is
     * not provided.
     */
     ...
     * @param password
     *            The password to access the sql database.
     * @param tableName
     *            The database table name.
     */
    public SqlDatabaseDescription(String url, String user, String password,
            String tableName) {
        this.url = url;
        this.user = user;
