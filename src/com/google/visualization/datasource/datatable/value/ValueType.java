...
public enum ValueType {
    BOOLEAN("BOOLEAN"), NUMBER("NUMBER"), TEXT("STRING"), DATE("DATE"), TIMEOFDAY(
     ...
     *
     * @param typeCode
     *            The type code string for the ValueType.
     */
     ...
     * class, otherwise an exception is thrown. Java native types/classes are
     * translated to Value in the following way: String -> TextValue Number
     * (inc. all derivatives such as Integer, Double) -> NumberValue Boolean ->
     * BooleanValue com.ibm.icu.util.GregorianCalendar -> DateValue,
     * DateTimeValue or TimeOfDayValue
     *
     * @param value
     *            The value to create.
     * @return A Value of this ValueType.
     * @throws TypeMismatchException
     *             When the type of value does not match this.
     */
