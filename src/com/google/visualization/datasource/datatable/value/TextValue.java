...
public class TextValue extends Value {
    ...
    public TextValue(String value) {
        if (value == null) {
            throw new NullPointerException(
                    "Cannot create a text value from null.");
        }
        this.value = value;
    }
    ...
    /**
     * Returns a comparator that compares text values according to a given
     * locale.
     *
     * @param ulocale
     *            The ulocale defining the order relation for text values.
     *
     * @return A comparator that compares text values according to a given
     *         locale.
     */
    public static Comparator<TextValue> getTextLocalizedComparator(
        ...
        if (value.contains("\"")) {
            if (value.contains("'")) {
                throw new RuntimeException(
                        "Cannot run toQueryString() on string"
