...
public class BooleanValue extends Value {
    ...
    /**
     * Static method to return a BooleanValue based on a given java boolean. If
     * the parameter is null, returns NULL_VALUE.
     *
     * @param value
     *            The java Boolean value to be represented.
     *
    ...
    /**
     * Create a new boolean value. This is private so users must use the three
     * predefined values here (Null, true, and false), like an enum.
     *
     * @param value
     *            The underlying value.
     */
