...
/**
 * A value of type time-of-day. Time is represented internally by four fields:
...
public class TimeOfDayValue extends Value {
     ...
     *             Thrown when one of the paramters is illegal.
     */
    ...
    public TimeOfDayValue(int hours, int minutes, int seconds, int milliseconds) {
        ...
        if ((minutes >= 60) || (minutes < 0)) {
            throw new IllegalArgumentException(
                    "This minutes value is invalid: " + minutes);
        }
        if ((seconds >= 60) || (seconds < 0)) {
            throw new IllegalArgumentException(
                    "This seconds value is invalid: " + seconds);
        }
        if ((milliseconds >= 1000) || (milliseconds < 0)) {
            throw new IllegalArgumentException(
                    "This milliseconds value is invalid: " + milliseconds);
        }
     ...
     * this constructor. Note: The date time values: hour, minute, second and
     * millisecond correspond to the values returned by calendar.get(field) of
     * the given calendar.
     *
     * @param calendar
     *            A GregorianCalendar from which to extract this instance
    ...
    /**
     * A method to retrieve a formattable object for this object. It is
     * important to set the GMT TimeZone to avoid conversions related to
     * TimeZone.
     */
    @Override
