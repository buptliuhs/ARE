...
public class ColumnDescription {
    ...
    /**
     * The column's identifier. This Id is used in query sort, filter and other
     * query elements that need to refer to specific columns.
     */
    private String id;
    ...
    /**
     * The column's formatting pattern. The pattern may be empty, otherwise
     * indicates the formatting pattern in which the column is already, or
     * should be, formatted.
     */
     ...
     *            The column's data type.
     * @param label
     *            The column's displayed name (label).
     */
     ...
     *
     * @param pattern
     *            A pattern to set for this column.
     */
     ...
     *
     * @param label
     *            A label to set for this column.
     */
    ...
    /**
     * Returns a clone of the ColumnDescription, meaning a column descriptor
     * with the exact same properties. This is a deep clone as it copies all
     * custom properties.
     *
