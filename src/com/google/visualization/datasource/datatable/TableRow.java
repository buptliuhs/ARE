 ...
 *
 * The number of cells is expected to match the number of columns in the table,
 * and the type of the value held in each cell is expected to match the type
 * defined for the corresponding column.
 *
 * @author Yoah B.D.
 */
public class TableRow {
     ...
     *
     * @param value
     *            The inner value of the cell to add.
     */
     ...
     *
     * @param value
     *            The inner numeric value of the cell to add.
     */
     ...
     *
     * @param value
     *            The inner boolean value of the cell to add.
     */
     ...
     *
     * @param value
     *            The inner text value of the cell to add.
     */
     ...
     *
     * @return The list of all cell values. The returned list is immutable.
     */
    ...
    /**
     * Package protected function. Replaces the cell at the specified position
     * in this row with the specified cell. The value type of the new cell must
     * match the that of the replaced one.
     * 
     * @param index
     ...
     *             Thrown if the index out of range.
     */
    TableCell setCell(int index, TableCell cell)
            throws IndexOutOfBoundsException {
