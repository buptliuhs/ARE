...
/**
 * A column. This can be either a column by ID, or an aggregation column such as
 * min(c1), etc.
 *
 * @author Yonatan B.Y.
 */
public abstract class AbstractColumn {
     ...
     * AbstractColumn. This is a list to support calculated columns in the
     * future. For example, a simple column would just return a list containing
     * its own ID. An aggregation column would just return a list containing the
     * ID of its aggregated column. In future, when calculated columns are
    ...
    /**
     * Checks whether the column is valid. Aggregation columns and scalar
     * function columns are valid if the aggregation or scalar function
     ...
     *             Thrown if the column is not valid.
     */
     ...
     * column, returns the value type of the column after evaluating the
     * function. For example, the value type of year(a1) is NUMBER.
     *
     * @param dataTable
     *            The data table.
     *
