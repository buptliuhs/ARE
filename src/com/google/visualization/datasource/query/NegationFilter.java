...
/**
 * A negation filter. Holds a sub-filter and negates its result, acting like the
 * NOT operator.
 *
 * @author Yonatan B.Y.
 */
public class NegationFilter extends QueryFilter {
     ...
     * calling isMatch on the sub-filter and negating the result.
     *
     * @param table
     ...
     * case the scalarFunctionColumns its sub-filter uses.
     *
    ...
    public int hashCode() {
        ...
        int result = 1;
        result = prime * result
                + ((subFilter == null) ? 0 : subFilter.hashCode());
        return result;
    }
