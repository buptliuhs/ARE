...
/**
 * The binary scalar function difference(). Returns the difference between two
 * number values.
 *
 * @author Liron L.
 */
public class Difference implements ScalarFunction {
    ...
    /**
     * Executes the scalar function difference() on the given values. Returns
     * the difference between the given values. All values are number values.
     * The method does not validate the parameters, the user must check the
     * parameters before calling this method.
     *
     * @param values
     *            A list of the values on which the scalar function will be
     *            performed.
     *
     * @return Value with the difference of all given values, or number null
