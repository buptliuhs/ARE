...
/**
 * The binary scalar function product(). Returns the product of two number
 * values.
 *
 * @author Liron L.
 */
public class Product implements ScalarFunction {
     ...
     * product of the given values. All values are number values. The method
    ...
    public Value evaluate(List<Value> values) {
        ...
        double product = ((NumberValue) values.get(0)).getValue()
