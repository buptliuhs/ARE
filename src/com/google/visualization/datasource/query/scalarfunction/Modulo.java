...
/**
 * The binary scalar function modulo(). Returns the modulo between two number
 * values.
 *
 * @author Roee E.
 */
public class Modulo implements ScalarFunction {
    ...
    /**
     * Executes a binary scalar function modulo() between the first and the
     * second values in the list. Returns the modulo between the given values.
     * All values are number values. The method does not validate the
     * parameters, the user must check the parameters before calling this
     * method.
     *
     * @param values
     *            A list of values on which the scalar function is performed.
     *
     *
     * @return Value with the modulo between two given values, or number null
     *         value if one of the values is null.
     */
    ...
    public String toQueryString(List<String> argumentsQueryStrings) {
        return "(" + argumentsQueryStrings.get(0) + " % "
