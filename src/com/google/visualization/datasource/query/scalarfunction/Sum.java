...
public class Sum implements ScalarFunction {
    ...
    /**
     * Executes the scalar function sum() on the given values. Returns the sum
     * of the given values. All values are number values. The method does not
     * validate the parameters, the user must check the parameters before
     * calling this method.
     *
     * @param values
     *            A list of values on which the scalar function is performed.
     *
     * @return Value with the sum of all given values, or number null value if
