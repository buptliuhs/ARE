...
/**
 * The binary scalar function quotient(). Returns the quotient of two values.
 * Division by zero returns a null number value.
 *
 * @author Liron L.
 */
public class Quotient implements ScalarFunction {
     ...
     * zero returns a null number value. The method does not validate the
     ...
     *         if one of the values is null or if one of the denominators is
     *         zero.
     */
