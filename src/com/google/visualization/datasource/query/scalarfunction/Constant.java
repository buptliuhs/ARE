...
/**
 * A constant function, i.e., a 0-ary function that always returns the same
 * value, given at construction time. The value can be of any supported
 * {@link ValueType}.
 *
 * @author Liron L.
 */
public class Constant implements ScalarFunction {
     ...
     * 
     * @param value
     *            The value to constantly return.
     */
    ...
    /**
     * Executes the scalar function constant(). The <code>values</code>
     * parameter is ignored. Returns the value supplied at construction time.
     *
     * @param values
     *            Ignored.
     *
    ...
    /**
     * Returns the return type of the function. This matches the type of the
     * value supplied at construction time. The <code>types</code> parameter is
     * ignored.
     *
     * @param types
     *            Ignored.
     ...
     *
     * @param types
     *            A list with parameters types. Should be empty for this type of
     *            function.
     *
    ...
    public void validateParameters(List<ValueType> types)
        ...
        if (types.size() != 0) {
            throw new InvalidQueryException(
                    "The constant function should not get " + "any parameters");
        }
    }
