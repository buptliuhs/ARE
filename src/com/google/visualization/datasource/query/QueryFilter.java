...
/**
 * A query filter. Any class that implements this interface can act as a filter,
 * i.e., be the part of a query that decides for a given TableRow if that row is
...
public abstract class QueryFilter {
    ...
    /**
     * Returns a list of all aggregation columns this filter uses. This is kept
     * for future use, as currently filters are not allowed to have aggregation
     * columns. This is still used currently for validation purposes.
     * 
