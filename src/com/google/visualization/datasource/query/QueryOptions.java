...
/**
 * Options definition for a query. Holds options for the query that fall under
 * the options clause.
 *
 * @author Yonatan B.Y.
 */
public class QueryOptions {
    ...
    /**
     * Should be set to indicate not to format the values, but to return only
     * the raw data. By default returns both raw and formatted values.
     */
     ...
     *
     * @param noValues
     *            The new value of the noValues option.
     */
     ...
     *
     * @param noFormat
     *            The new value of the noFormat option.
     */
    ...
    /**
     * Returns a string that when fed to the query parser should return a
     * QueryOptions equal to this one. Used mainly for debugging purposes. The
     * string returned does not contain the OPTIONS keyword.
     * 
