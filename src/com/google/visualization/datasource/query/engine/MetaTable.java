...
/**
 * Holds the data of a table after pivoting and grouping, indexed by
 * {@link RowTitle} and {@link ColumnTitle}.
 *
 * @author Yonatan B.Y.
 */
/* package */class MetaTable {
     ...
     *
     * @param rowTitle
     *            The row into which the cell should be inserted.
     * @param columnTitle
     *            The column into which the cell should be inserted.
     * @param cell
     *            The cell to insert.
     */
     ...
     *
     * @param rowTitle
     *            The row from which to retrieve the cell.
     * @param columnTitle
     *            The column from which to retrieve the cell.
     *
    ...
    /**
     * Retrieves an entire row, in the form of a hashtable that maps a
     * ColumnTitle to a TableCell.
     *
     * @param rowTitle
     *            The title of the row to retrieve.
     *
     * @return The row.
     */
