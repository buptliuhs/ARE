...
/**
 * A "title" (identification) of a row in a pivoted and/or grouped table. What
 * identifies a row is the list of values, one value from each of the group-by
 * columns.
 *
 * @author Yonatan B.Y.
 */
/* package */class RowTitle {
     ...
     *
     * @param values
     *            The list of group-by column values.
     */
