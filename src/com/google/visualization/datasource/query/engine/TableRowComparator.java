...
/**
 * A comparator comparing two {@link TableRow}s according to the query's ORDER
 * BY, i.e., {@link QuerySort}.
 *
 * @author Yoah B.D.
 */
/* package */class TableRowComparator implements Comparator<TableRow> {
    ...
    /**
     * The sort order of the columns to order by, in sequence of importance.
     * Will be of same size as sortColumnIndex.
     */
     ...
     * @param locale
     *            The locale defining the order relation of text values.
     * @param lookup
     *            The column lookup.
     */
    public TableRowComparator(QuerySort sort, ULocale locale,
            ColumnLookup lookup) {
    ...
    /**
     * Compares two arguments for order. Returns a negative integer, zero, or a
     * positive integer if the first argument is less than, equal to, or greater
     * than the second.
     *
     * @param r1
     *            the first row to be compared.
     * @param r2
