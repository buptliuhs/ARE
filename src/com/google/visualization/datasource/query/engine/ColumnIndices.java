...
/**
 * Holds a mapping between {@link AbstractColumn}s and lists of indices, i.e.,
 * holds a list of indices for each column. The indices for a column are the
 * indices in the new datatable, generated by a grouping/pivoting operation.
 * There may be many indices for one column because a pivoting operation creates
 * a few columns for a single original column.
 *
 * @author Yonatan B.Y.
 */
/* package */class ColumnIndices {
    ...
    /**
     * Returns the index of the given column. If there is more than one index
     * for the column, a runtime exception is thrown.
     *
     * @param col
