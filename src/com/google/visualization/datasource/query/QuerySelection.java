...
/**
 * Selection definition for a query. Selection is defined as a list of column
 * IDs. It can also include aggregations for grouping/pivoting and scalar
 * functions.
 * 
 *
 * @author Itai R.
...
public class QuerySelection {
     ...
     *
     * @param source
     *            The source query selection from which to construct.
     */
     ...
     * QuerySelection. The string is returned without the SELECT keyword.
     * 
