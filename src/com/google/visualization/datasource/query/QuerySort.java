...
/**
 * Sorting definition for a query. Sort is defined as a list of column sorts
 * where the first is the primary sort order, the second is the secondary sort
 * order, etc.
 *
 * @author Yoah B.D.
 */
public class QuerySort {
    ...
    /**
     * Adds a column sort condition. Validates that the column ID is not already
     * specified in the sort.
     *
     * @param columnSort
     *            The column sort condition.
     */
    ...
    public List<AbstractColumn> getColumns() {
        List<AbstractColumn> result = Lists
                .newArrayListWithExpectedSize(sortColumns.size());
    ...
    public int hashCode() {
        ...
        int result = 1;
        result = prime * result
                + ((sortColumns == null) ? 0 : sortColumns.hashCode());
        return result;
    }
     ...
     * QuerySort. The string returned does not contain the ORDER BY keywords.
     * 
