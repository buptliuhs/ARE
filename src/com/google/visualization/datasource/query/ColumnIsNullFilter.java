...
/**
 * A filter that matches null values. Its isMatch function returns true if the
 * value at the column is a null value (as defined by TableCell.isNull()).
 *
 * @author Yonatan B.Y.
 */
public class ColumnIsNullFilter extends QueryFilter {
     ...
     * case the scalarFunctionColumns in column (e.g, in the filter 'year(a) is
     * null' it will return year(a).
     *
