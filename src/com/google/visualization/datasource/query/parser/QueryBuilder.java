...
/**
 * A singleton class that can parse a user query string, i.e., accept a string
 * such as "SELECT dept, max(salary) GROUP BY dept" and return a Query object.
 * This class basically wraps the QueryParser class that is auto-generated from
 * the QueryParser.jj specification.
 *
 * @author Hillel M.
 */
public class QueryBuilder {
    ...
    /**
     * Private constructor, to prevent instantiation other than that of the
     * singleton instance.
     */
     ...
     *             Thrown if the query is invalid.
     */
    public Query parseQuery(String tqValue, ULocale ulocale)
            throws InvalidQueryException {
        Query query;
        if (StringUtils.isEmpty(tqValue)) {
            ...
            try {
                ...
                throw new InvalidQueryException(
                        MessagesEnum.PARSE_ERROR.getMessageWithArgs(ulocale,
                                messageToUserAndLog));
            }
