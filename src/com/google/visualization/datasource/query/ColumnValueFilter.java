...
public class ColumnValueFilter extends ComparisonFilter {
     ...
     *            The column to compare.
     * @param value
     *            The constant value the column value is compared to.
     * @param operator
     *            The comparison operator to use.
     * @param isComparisonOrderReversed
     *            Whether to reverse the comparison order of the operator.
     */
     ...
     * retrieves from the row, the data in the required column, and compares it
     * against the constant value, using the operator given in the constructor.
     *
     * @param table
     ...
     *         operator returns true when run on the value in the column, and
     *         the constant value; false otherwise.
     */
    @Override
    ...
    /**
     * Returns all the columnIds this filter uses, in this case the simple
     * column IDs of the filter's column.
     *
     ...
     * case the scalarFunctionColumns in the filter's column (e.g, in thefilter
     ...
     * means whether the column and the value should be reversed, i.e., instead
     * of column op value, this will be value op column.
     *
