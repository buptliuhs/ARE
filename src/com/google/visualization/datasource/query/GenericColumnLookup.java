...
/**
 * This class represents a generic column lookup. It maps an abstract column to
 * its index in a table description.
 *
 * @author Liron L.
 */
public class GenericColumnLookup implements ColumnLookup {
     ...
     *
     * @param col
     *            The column to set the index of.
     * @param index
     *            The index to set for the column.
     */
