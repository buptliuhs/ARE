...
public class ColumnColumnFilter extends ComparisonFilter {
    ...
    /**
     * The second column. This is the column with which the first column is
     * compared.
     */
    private AbstractColumn secondColumn;

    /**
     * Constructs a new ColumnColumnFilter on two given columns, and an
     * operator.
     *
     * @param firstColumn
     *            The first column.
    ...
    /**
     * Returns all the simple column IDs this filter uses, in this case the
     * simple column IDs of firstColumn and secondColumn.
     *
     * @return All the column IDs this filter uses.
     */
    @Override
    public Set<String> getAllColumnIds() {
        Set<String> columnIds = Sets.newHashSet(firstColumn
     ...
     * case the scalarFunctionColumns in the first and second columns (e.g, in
     * the filter year(a) = year(date(b)) it will return year(a), year(date(b))
     * and date(b)).
     *
    ...
    public List<ScalarFunctionColumn> getScalarFunctionColumns() {
        ...
        scalarFunctionColumns
                .addAll(secondColumn.getAllScalarFunctionColumns());
    ...
    public int hashCode() {
        ...
        int result = 1;
        result = prime * result
                + ((firstColumn == null) ? 0 : firstColumn.hashCode());
        result = prime * result
                + ((secondColumn == null) ? 0 : secondColumn.hashCode());
        return result;
    }
