...
/**
 * A helper class responsible for writing a response message on a
...
public class ResponseWriter {
     ...
     */
    private static final byte[] UTF_16LE_BOM = new byte[] { (byte) 0xff,
            (byte) 0xfe };
     ...
     * <code>HttpServletResponse</code>. This method assumes the
     * <code>StatusType</code> is 'OK'.
     *
    ...
    public static void setServletResponse(String responseMessage,
            DataSourceParameters dataSourceParameters, HttpServletResponse res)
            throws IOException {
    ...
    /**
     * Sets the specified responseMessage on the given
     * <code>HttpServletResponse</code> if the <code>OutputType</code> is CSV.
     ...
     *             In case of a I/O error.
     */
    static void setServletResponseCSV(
            DataSourceParameters dataSourceParameters, HttpServletResponse res) {
    ...
    /**
     * Sets the HTTP servlet response for a TSV_EXCEL output type. This method
     * assumes the <code>StatusType</code> is 'OK'.
     *
     * @param responseMessage
     *            The response message.
     * @param dsParams
    ...
    /**
     * Sets the HTTP servlet response for a HTML output type. This method
     * assumes the <code>StatusType</code> is 'OK'.
     *
     * @param responseMessage
     *            The response message.
    ...
    /**
     * Sets the HTTP servlet response for a JSONP output type. This method
     * assumes the <code>StatusType</code> is 'OK'.
     *
     * @param responseMessage
     *            The response char sequence.
     * @param res
     *            The HTTP response.
     *
     * @throws IOException
    ...
    /**
     * Sets the HTTP servlet response for a JSON output type. This method
     * assumes the <code>StatusType</code> is 'OK'.
     *
     * @param responseMessage
     *            The response char sequence.
     ...
     *
     * @param responseMessage
     *            A charSequence to write to the servlet response.
     * @param res
     ...
     *             In case of a I/O error.
     */
    private static void writeServletResponse(CharSequence responseMessage,
            HttpServletResponse res) throws IOException {
        writeServletResponse(responseMessage, res, "UTF-8", null);
    }

    /**
     * Writes the response to the servlet response using specified charset and
     ...
     *            The servlet response.
     * @param charset
     *            A {@code String} specifying one of the character sets defined
     *            by IANA Character Sets
     ...
     *             In case of a I/O error.
     */
    private static void writeServletResponse(CharSequence charSequence,
            HttpServletResponse res, String charset, byte[] byteOrderMark)
            throws IOException {
