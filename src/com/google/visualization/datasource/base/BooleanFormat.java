 ...
 *
 * The string representation of boolean values is determined by two strings
 * passed to the constructor of this class; a string for <code>TRUE</code> and a
 * string for <code>FALSE</code>.
 * 
 * Examples for text strings representing a BooleanValue that can be used in
 * construction are: 1) true, false 2) TRUE, FALSE 2) t, f 3) yes, no 4) YES, NO
 * 5) check, uncheck 6) Green, Red
 *
 * @author Hillel M.
 */
...
public class BooleanFormat extends UFormat {
     ...
     * @param appendTo
     *            The StringBuffer to which the formatted string will be
     *            appended.
     * @param pos
     *            A FieldPosition param (not used in this class).
     *
    ...
    /**
     * Parses a string into a {@code Boolean}. A string can be either a
     * trueString or a falseString (non-case sensitive).
     *
     * @param source
     ...
     *
     * @param text
     *            A String that should be parsed from it's start.
     *
