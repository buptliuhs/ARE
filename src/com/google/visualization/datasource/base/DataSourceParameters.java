...
/**
 * This class contains the data source parameters of the request. The data
 * source parameters are extracted from the "tqx" URL parameter.
 *
 * @author Nimrod T.
 */
public class DataSourceParameters {
     ...
     * Log.
     */
    private static final Log log = LogFactory.getLog(DataSourceParameters.class
            .getName());

    /**
     * The name of the request id parameter as it appears in the "tqx" URL
     * parameter.
     */
    private static final String REQUEST_ID_PARAM_NAME = "reqId";

    /**
     * The name of the data signature parameter as it appears in the "tqx" URL
     * parameter.
     */
    private static final String SIGNATURE_PARAM_NAME = "sig";

    /**
     * The name of the output type parameter as it appears in the "tqx" URL
     * parameter.
     */
    private static final String OUTPUT_TYPE_PARAM_NAME = "out";

    /**
     * The name of the response handler parameter as it appears in the "tqx" URL
     * parameter.
     */
    private static final String RESPONSE_HANDLER_PARAM_NAME = "responseHandler";

    /**
     * The name of the filename parameter as it appears in the "tqx" URL
     * parameter. This is relevant only if the "out" parameter is "csv". In that
     * case, if the outFileName is given, this is the name of the csv that the
     * datasource will output. Otherwise, if missing, the default filename
     * (data.csv) is used.
     */
    ...
    /**
     * Constructs a new instance of this class, with the given "tqx" string and
     * parses it.
     *
     ...
     * 
     * @param tqxValue
     *            The "tqx" string to parse.
     * @throws DataSourceException
     *             Thrown if parsing of request parameters fails.
     */
