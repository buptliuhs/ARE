...
/**
 * An exception to be used by callers and callees of the library. Each exception
 * has a type taken from <code>ReasonType</code>, and a message that can be used
 * to output an appropriate message to the user.
 *
 * Example: new DataSourceException(ReasonType.InvalidQuery,
