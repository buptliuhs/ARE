...
public enum ReasonType {
     ...
     * authentication. Enable the data source to distinguish between 'no user'
     * and 'user has no access' scenarios.
     */
    USER_NOT_AUTHENTICATED,

    /**
     * The query sent to the data source contains an operation that the data
    ...
    /**
     * The request has timed out. This is used only in the client, it is defined
    ...
    /**
     * Any other error that occured and prevented the data source from
     ...
     */
    private static final Map<ReasonType, String> REASON_TYPE_TO_MESSAGE = Maps
            .newEnumMap(ReasonType.class);
    ...
    public String getMessageForReasonType(Locale locale) {
        return LocaleUtil.getLocalizedMessageFromBundle(
                ...
                REASON_TYPE_TO_MESSAGE.get(this), locale);
    }
