...
(function(factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    ...
    define([ 'jquery', 'tmpl', './jquery.fileupload-image', './jquery.fileupload-audio', './jquery.fileupload-video',
  ...
  $.widget('blueimp.fileupload', $.blueimp.fileupload,
      {
        ...
        options : {
          ...
          send : function(e, data) {
            ...
            if (data.context && data.dataType && data.dataType.substr(0, 6) === 'iframe') {
              ...
              data.context.find('.progress').addClass(!$.support.transition && 'progress-animated').attr('aria-valuenow', 100).children()
                  .first().css('width', '100%');
            }
          ...
          // Callback for successful uploads:
            ...
            var that = $(this).data('blueimp-fileupload') || $(this).data('fileupload'), getFilesFromResponse = data.getFilesFromResponse
          ...
          fail : function(e, data) {
            ...
            if (data.context) {
              ...
              data.context = that._renderUpload(data.files)[that.options.prependFiles ? 'prependTo' : 'appendTo'](
          ...
          progressall : function(e, data) {
            ...
            var $this = $(this), progress = Math.floor(data.loaded / data.total * 100), globalProgressNode = $this
                .find('.fileupload-progress'), extendedProgressNode = globalProgressNode.find('.progress-extended');
        ...
        _formatTime : function(seconds) {
          ...
          days = days ? days + 'd ' : '';
          return days + ('0' + date.getUTCHours()).slice(-2) + ':' + ('0' + date.getUTCMinutes()).slice(-2) + ':'
        ...
        _renderExtendedProgress : function(data) {
          return this._formatBitrate(data.bitrate) + ' | ' + this._formatTime((data.total - data.loaded) * 8 / data.bitrate) + ' | '
              + this._formatPercentage(data.loaded / data.total) + ' | ' + this._formatFileSize(data.loaded) + ' / '
        ...
        _deleteHandler : function(e) {
          e.preventDefault();
          // 02/09/2015: Modified by Huansheng Liu. Confirm before deletion
          var fileName = e.currentTarget.attributes["data-file"].nodeValue;
          ...
          bootbox.confirm({
            ...
            callback : function(result) {
              if (result) {
                handler._trigger('destroy', e, $.extend({
